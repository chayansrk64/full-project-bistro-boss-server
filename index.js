...
async function run() {
  try {
    ...
    const verifyAdmin = async(req, res, next) => {
     ...
     /**
      * 1. Do not show secure links who should not see links
  ...
  // best solution is( mongodb aggrete pipeline )
  // order statistics (second best solution)

  /**
   * 1. load all payments
   * 2. for each payment, get the menuItems array
   * 3. for each item in the menuItems array ge the menuItem form the menu collection
   * 4. put then in an array: allOrderedItems
   * 5. separate ollOrderdItems by category using filter
